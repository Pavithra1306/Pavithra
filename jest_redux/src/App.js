...
export class App extends Component {
  ...
  //  await this.props.getCurrentUserData(selected)
  //  console.log(this.props.currentData);
  //  document.getElementById("imgSpace").setAttribute("src",this.props.currentData.avatar);
  //  document.getElementById("userDetails").innerHTML=this.props.currentData.first_name+" "+this.props.currentData.last_name;
